...
android {
    ...
    buildTypes {
        release {
            ...
            buildConfigStringField("BASE_IMG_URL", Configs.Release.ImageUrl)
            buildConfigStringField("BASE_BACKDROP_URL", Configs.Release.BackdropUrl)
            buildConfigStringField("DB_NAME", Configs.Release.DbName)
        }

        debug {
            buildConfigStringField("BASE_URL", Configs.Debug.BaseUrl)
            buildConfigStringField("BASE_IMG_URL", Configs.Debug.ImageUrl)
            buildConfigStringField("BASE_BACKDROP_URL", Configs.Debug.BackdropUrl)
